...
<!-- output: -->
<!--   xaringan::moon_reader: -->
<!--     css: [default, xaringan-themer.css, metropolis, metropolis-fonts] -->
<!--     lib_dir: libs -->
<!--     nature: -->
<!--       highlightStyle: github -->
<!--       highlightLines: true -->
...
```{nomnoml, fig.width=12, fig.height=8}
#stroke: orange
#direction: down
#align: center
...
* Verbal vs. Non-verbal
  * Verbal Scales: 6 Basic Emotions, PANAS, Geneva Emotion Wheel ...
  * Non-Verbal Scales: SAM, PrEmo, Affect button ...
...
Wired vs. Wireless
* wristbands: Empatica, Shimmer, Apple watch, all fitness watches ...
* belts and shirts: Biopack, Equivital, Hexoskin ...
* other: Notch, iMotions ...
...
Human vs. Automatic
* Human annotation using Emotions, FACS ... with annotation software (ELAN, ANVIL, the Observer, ...)
* Automatic recognition using Emotions, FACS ... with OpenFace, Affectiva, FaceReader ...
...
# Accessing data and data wrangling
...
* Artefact removal
  ...
  * NA value
  * Spline / Linear approximate
]

.pull-right[
```{r out.width = "50%"}
knitr::include_graphics("./img/artefact.png") 
```
]
...
* Streams directly interpretable
  * Heart Rate (HR)
  * Breathing Rate (BR)
  * Skin Temperature (ST)

* Streans needs feature extraction
  * Electrodermal Activity (EDA)
  * Electrocardiogram (ECG)

---

# 2. Feature Extraction of EDA

* EDA decomposition to: 
  * Skin conductance level (SCL)
  * Skin conductance response (SCR)

```{r out.width = "100%"}
knitr::include_graphics("./img/eda.png") 
```
...
* ECG decomposition to Heart Rate Variability (HRV)
* not presented hereafter but can be easily done with {RHRV} package

```{r out.width = "100%"}
knitr::include_graphics("./img/hrv.png") 
```
...
* Extrapolation of the missing between values (Spline)

---

# 4. Statistical Treatment

* Predicted trend extraction per measure, for example:
  * Generalized Additive Mixed Model (GAMM)

```{r out.width = "70%"}
knitr::include_graphics("./img/gamm.png") 
```

---

# Predict Arousal from physiology
...
* Extract features from HR, BR and ST
